                            ...
                            @foreach ($categories as $categorie)
                                <tr class="datos" id="{{ $categorie->id }}">
                                    <th
                                        ...
                                        <input type="text" id="categorie{{ $categorie->id }}" readonly="true"
                                            value="{{ $categorie->name }}">
                                    </th>
                                    <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 whitespace-nowrap p-4 ">
                                        <a href="#" class="categorieEdit"><i class="far fa-edit"
                                    ...
                                    <th>
                                        ...
                                        <div x-data="{modal{{ $categorie->id }}: false}"
                                            :class="{
                                                ...
                                                <div
                                                    ...
                                                    <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20"
                                                        ...
                                                        <main class="p-2 text-center">
                                                            <p>
                                                                ¿Esta seguro de que desea eliminar este registro (Este
                                                                proceso es
                                                                irreversible)?
                                                            </p>
                                                        </main>
                                                        <footer class="flex justify-center p-2">
                                                            ...
                                                            <button
                                                                class="bg-red-600 font-semibold text-white p-2 w-32 rounded-full hover:bg-red-700 focus:outline-none focus:ring shadow-lg hover:shadow-none transition-all duration-300 categorieDelete"
                                                                eliminar="{{ $categorie->id }}">Eliminar</button>
