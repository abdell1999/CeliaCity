...
<!-- HOME START-->
       <!--Primera imagen--> <section class="bg-half d-table w-100 coverpage" style="background-image:url('images/home/CeliaCityInicio.png')" id="home">
                        ...
                        <div class="faqs mt-4 pt-2">
                            <div class="accordion" id="accordionExample2" role="tablist" aria-multiselectable="true">                                
                                <div class="card border-0 rounded-0">
                                    <div class="card-header p-0" id="History">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title text-uppercase fw-normal mb-4">Puntos <span class="text-primary fw-bold">Destacados</span> </h4>
                            <p class="text-muted mx-auto para-desc mb-0">Aquí tienes los tres puntos más destacados de Macael</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-around">
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team-content position-relative text-center bg-light rounded">
                            ...
                            <div class="detail pt-3 pb-3 p-1">
                                <h4 class="mb-0"><a href="javascript:void(0)" class="name text-dark pointname1">Nombre del punto</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team-content position-relative text-center bg-light rounded">
                            ...
                            <div class="detail pt-3 pb-3 p-1">
                                <h4 class="mb-0"><a href="javascript:void(0)" class="name text-dark pointname2">Nombre del punto</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team-content position-relative text-center bg-light rounded">
                            ...
                            <div class="detail pt-3 pb-3 p-1">
                                <h4 class="mb-0"><a href="javascript:void(0)" class="name text-dark pointname3">Nombre del punto</a></h4>
