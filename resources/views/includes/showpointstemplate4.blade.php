<!-- Start Modal Delete Comment -->
  ...
  <div class="modal fade" id="deleteComment" tabindex="-1" role="dialog" aria-labelledby="deleteCommentLabel" aria-hidden="true">
    ...
    <body style="background-color: #abd1c6;">
        <section class="contenido" style="display:flex; padding-top: 150px;">
        ...
        <!-- Map start Bootstrap -->
        <div class="rounded shadow-lg container bg-light mt-20 pb-20">
            <h2 class="card-title pt-5" style="color: #EEC41E;">Localización</h2>
