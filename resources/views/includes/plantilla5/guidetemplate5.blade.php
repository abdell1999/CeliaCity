 ...
 <div class="container mt-100 pt-20" style="padding-top: 100px;">
     <h2 class="text-5xl font-bold leading-tight mt-0 mb-2 text-center" style="padding-top: 1%">Historia de
         {{ $dataoptions['townname'] }}</h2>
     <br>
 ...
 @foreach ($pointofinterests as $point)
     <ul class="">
         <script>
             ...
             marker.bindPopup(
                     '<a target="_blank" href="/pointofinterest/{{ $point->slug }}"><b>{{ $point->name }}</b></a>')
                 .openPopup();
         </script>
