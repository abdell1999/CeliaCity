...
<body style="background-color: #abd1c6;">
    <section class="contenido" style="display:flex; padding-top: 150px; padding-bottom:5%;">
                        ...
                        @foreach ($resources as $resource)
                            ...
                            @else
                                <div class="swiper-slide shadow-lg rounded">
                                    ...
                                    <video muted controls preload disablepictureinpicture
                                        style="width: 100%; height: 100%;">
                                        <source src="{{ url($resource->route) }}"
                                            type="video/{{ substr($resource->route, strpos($resource->route, '.') + 1) }}">
                                    </video>
                                </div>
                            @endif
                        @endforeach
    ...
    <!-- Map start Bootstrap -->
    <div class="rounded shadow-lg container bg-light pb-20">
        <h2 class="card-title" style="color: #50C594;">Localización</h2>
    ...
    @endif
    <h2 class="mt-20" style="color: #50C594; padding-top:5%;">Opiniones</h2>
    <div>
        <div class="col-md-8">
    ...
    <!-- MODAL SLIDER-->
    <div class="modal fade" id="zoomImage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="slider zoom" style="position:fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff;" class="swiper mySwiper2">
                <button class="btn-closeModal border-0 bg-transparent d-flex flex-row-reverse w-100"
                    id="btn-closeModal"><i class="far fa-times-circle text-warning btn-lg m-0 p-0"
                        id="eeee"></i></button>
                <div class="swiper-wrapper">
                        ...
                        @else
                            <div class="swiper-slide shadow-lg rounded">
                                ...
                                <video muted controls preload>
                                    <source src="{{ url($resource->route) }}"
                                        type="video/{{ strtok($resource->route, '.') }}`">
                                </video>
                            </div>
                        @endif
                    @endforeach
