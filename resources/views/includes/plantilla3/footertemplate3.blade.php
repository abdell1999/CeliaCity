 ...
 <footer class="footer py-5 bg-dark ">
                ...
                <div class="row justify-content-around">
                    <div class="col-lg-4 col-md-12">
                        ...
                        <ul class="list-unstyled social-icon social mb-0">
                            ...
                            <li class="list-inline-item"><a href="https://www.linkedin.com/in/francisco-javier-j-309a7611a/" target="_blank" ><i class="mdi mdi-linkedin" title="linkedin"></i></a></li>
                            <li class="list-inline-item"><a href="#" target="_blank"><i class="mdi mdi-linkedin" title="linkedin"></i></a></li>
                            <li class="list-inline-item"><a href="#" target="_blank"><i class="mdi mdi-linkedin" title="linkedin"></i></a></li>
                            <li class="list-inline-item"><a href="#" target="_blank"><i class="mdi mdi-linkedin" title="linkedin"></i></a></li>
        ...
        <footer class="footer bg-dark footer-bar py-4">
            <div class="container text-foot text-center">
                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Design with <i class="mdi mdi-heart text-danger"></i> by <a href="http://www.Themesdesign.in" target="_blank" class="text-reset">CeliaCity</a>.</p>
            </div><!--end container-->
        </footer><!--end footer-->
        <!-- Footer End -->        
        </div>
