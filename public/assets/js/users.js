        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.user, function (key, item) {
                    ...
                    <a href='#' class='text-indigo-600 hover:text-indigo-900 editBtn' value=" +
                            item.id +
                            " data-bs-target='#modalEditar'>Edit</a>\
                    <a href='#' class='text-indigo-600 hover:text-indigo-900 deletebtn' value=" +
                            item.id +
                            " data-bs-target='#DeleteModal'>Delete</a></td></tr>\
                    </tr>"
                    );
                });
