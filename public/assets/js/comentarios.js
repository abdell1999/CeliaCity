...
function fetchcomment(id_pointofinterest){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            comentarios.innerHTML += "<div class='col-md-8'> <div class='media g-mb-30 media-comment'> <img class='d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15' src='"+photo+"' alt='Image Description'> <div class='media-body u-shadow-v18 g-bg-secondary g-pa-30'> <div class='g-mb-15'> <h5 class='h5 g-color-gray-dark-v1 mb-0'>"+name+"</h5> </div> <p>"+comment.text+"</p> <ul class='list-inline d-sm-flex my-0'> </ul> </div> </div>";
